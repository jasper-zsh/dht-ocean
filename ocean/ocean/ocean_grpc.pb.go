...
const (
	Ocean_IfInfoHashExists_FullMethodName          = "/ocean.Ocean/IfInfoHashExists"
	Ocean_BatchInfoHashExist_FullMethodName        = "/ocean.Ocean/BatchInfoHashExist"
	Ocean_CommitTorrent_FullMethodName             = "/ocean.Ocean/CommitTorrent"
	Ocean_ListTorrentInfoForTracker_FullMethodName = "/ocean.Ocean/ListTorrentInfoForTracker"
	Ocean_UpdateTracker_FullMethodName             = "/ocean.Ocean/UpdateTracker"
	Ocean_BatchUpdateTracker_FullMethodName        = "/ocean.Ocean/BatchUpdateTracker"
)
...
func (c *oceanClient) IfInfoHashExists(ctx context.Context, in *IfInfoHashExistsRequest, opts ...grpc.CallOption) (*IfInfoHashExistsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ocean_IfInfoHashExists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oceanClient) BatchInfoHashExist(ctx context.Context, in *BatchInfoHashExistRequest, opts ...grpc.CallOption) (*BatchInfoHashExistResponse, error) {
	out := new(BatchInfoHashExistResponse)
	err := c.cc.Invoke(ctx, Ocean_BatchInfoHashExist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oceanClient) CommitTorrent(ctx context.Context, in *CommitTorrentRequest, opts ...grpc.CallOption) (*CommitTorrentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ocean_CommitTorrent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oceanClient) ListTorrentInfoForTracker(ctx context.Context, in *ListTorrentInfoForTrackerRequest, opts ...grpc.CallOption) (*ListTorrentInfoForTrackerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ocean_ListTorrentInfoForTracker_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oceanClient) UpdateTracker(ctx context.Context, in *UpdateTrackerRequest, opts ...grpc.CallOption) (*UpdateTrackerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ocean_UpdateTracker_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oceanClient) BatchUpdateTracker(ctx context.Context, in *BatchUpdateTrackerRequest, opts ...grpc.CallOption) (*BatchUpdateTrackerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ocean_BatchUpdateTracker_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OceanServer interface {
	...
	BatchInfoHashExist(context.Context, *BatchInfoHashExistRequest) (*BatchInfoHashExistResponse, error)
...
func (UnimplementedOceanServer) BatchInfoHashExist(context.Context, *BatchInfoHashExistRequest) (*BatchInfoHashExistResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchInfoHashExist not implemented")
}
...
func _Ocean_IfInfoHashExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_IfInfoHashExists_FullMethodName,
	}
...
func _Ocean_BatchInfoHashExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchInfoHashExistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OceanServer).BatchInfoHashExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_BatchInfoHashExist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OceanServer).BatchInfoHashExist(ctx, req.(*BatchInfoHashExistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Ocean_CommitTorrent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_CommitTorrent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Ocean_ListTorrentInfoForTracker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_ListTorrentInfoForTracker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Ocean_UpdateTracker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_UpdateTracker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Ocean_BatchUpdateTracker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ocean_BatchUpdateTracker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Ocean_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchInfoHashExist",
			Handler:    _Ocean_BatchInfoHashExist_Handler,
		},
		{
